...
export default async function handler(req, res) {
    ...
    try {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <p style="color: #64748b; font-size: 12px; margin-top: 30px;">
                        This email was sent from the Hydro Heroes website contact form via Vercel.
                    </p>
                </div>
            `
        });
        ...
        return res.status(500).json({ error: 'Internal server function error', details: error.message });
    }
}
